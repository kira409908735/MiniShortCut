        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            using (DBContext context = new DBContext())
            {
                if (!context.DatabaseExists())
                {
                    ...
                    context.Item.InsertOnSubmit(new ItemModel { ItemId = "wifi", ItemName = "WIFI", ItemIcon = "", ItemStatus = false });
                    context.Item.InsertOnSubmit(new ItemModel { ItemId = "cellular", ItemName = "手机网络", ItemIcon = "/Images/Industry/11.jpg", ItemStatus = false });
                    context.Item.InsertOnSubmit(new ItemModel { ItemId = "airplanemode", ItemName = "飞行模式", ItemIcon = "/Images/Industry/11.jpg", ItemStatus = false });
                    context.Item.InsertOnSubmit(new ItemModel { ItemId = "bluetooth", ItemName = "蓝牙", ItemIcon = "/Images/Industry/11.jpg", ItemStatus = false });
                    context.Item.InsertOnSubmit(new ItemModel { ItemId = "location", ItemName = "定位", ItemIcon = "/Images/Industry/11.jpg", ItemStatus = false });
                    context.Item.InsertOnSubmit(new ItemModel { ItemId = "screenrotation", ItemName = "屏幕旋转", ItemIcon = "/Images/Industry/11.jpg", ItemStatus = false });
